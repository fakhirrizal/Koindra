...
class App extends CI_Controller {
	...
	public function menu()
	{
		...
		// $data['data_jenis'] = $this->Main_model->manualQuery($q6);
		$this->load->view('student/template/header',$data);
		$this->load->view('student/app/menu',$data);
		$this->load->view('student/template/footer');
	}
	public function log_activity()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('student/template/header',$data);
		$this->load->view('student/app/log_activity',$data);
		$this->load->view('student/template/footer');
	}
	public function about()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('student/template/header',$data);
		$this->load->view('student/app/about',$data);
		$this->load->view('student/template/footer');
	}
	public function helper()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('student/template/header',$data);
		$this->load->view('student/app/helper',$data);
		$this->load->view('student/template/footer');
	}
