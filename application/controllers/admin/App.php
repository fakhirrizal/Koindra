...
class App extends CI_Controller {
	...
	*/
	...
	public function home()
	{
		...
		// 	'pos' => 'left',
		// ))->result();
		$data['kehadiran'] = $this->Main_model->getSelectedData('student a', 'a.*,(SELECT COUNT(b.presence_id) FROM presence b WHERE b.user_id=a.user_id) AS jumlah_kehadiran,q.quota', array('a.deleted'=>'0'), "jumlah_kehadiran DESC",'','','',array(
			'table' => 'status q',
			'on' => 'a.user_id=q.user_id',
			'pos' => 'left',
		))->result();
